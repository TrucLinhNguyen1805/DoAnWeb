<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
    	...
    	$sql = "UPDATE danhmuc SET danhmuc='$danhmuc' WHERE id='$id'";
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <?php
        ...
        $thongtindm = mysqli_fetch_array($ketqua);
      ?>
      <form action="" method="POST">
        <p><label>Danh mục:</label>
            <input type="text" name="danhmuc" class="form-control" value="<?php echo $thongtindm['danhmuc'];  ?>"></p>
